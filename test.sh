...
echo 'I think this issue may be caused by the difference between `entire data-based form` and `JSON data and form` payloads. Full logs can be found in `troubleshooting.md`.' >> README.md
